...
from main.models.handle_order_models import ProductImage, Category, SubCategory, ProductRating, Cart, \
    ProductComment, Order, Payment
from shared.functions import delete_main_photo, delete_all_photos
